...
Sin embargo, hay veces que desea [personalizar un pipeline](/docs/reference/components/build-packs/#pipelines) en particular (liberación, PR, característica, etc.) o modificar pasos involucrados dentro del [ciclo de vida](/docs/first-projects/build-packs/#life-cycles).
